...
<div class="tp-offcanvas">
    ...
    <div class="tp-offcanvas-gallery mb-50">
        <a class="popup-image" href="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/gallery-1.jpg"><img
                src="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/gallery-1.jpg" alt=""></a>
        <a class="popup-image" href="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/gallery-2.jpg"><img
                src="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/gallery-2.jpg" alt=""></a>
        <a class="popup-image" href="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/gallery-3.jpg"><img
                src="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/gallery-3.jpg" alt=""></a>
        <a class="popup-image" href="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/gallery-4.jpg"><img
                src="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/gallery-4.jpg" alt=""></a>
    </div>
