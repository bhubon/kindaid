<?php
$heade_button_text = get_theme_mod('button_text', __('Donate Now', 'kindaid'));
$heade_button_url = get_theme_mod('button_url', __('#', 'kindaid'));
$header_right_switch = get_theme_mod('header_right_switch', false);
$header_menu_column = $header_right_switch ? 'col-xxl-6 col-xl-6' : 'col-xxl-9 col-xl-10';
$header_menu_position = $header_right_switch ? 'text-center' : 'text-end';
?>
                                ...
                                <button class="tp-header-action-btn cartmini-open-btn">
                                    <svg width="23" height="24" viewBox="0 0 23 24" fill="none"
                                        ...
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M6.5781 23H16.1324C19.6419 23 22.3343 21.7324 21.5695 16.6305L20.679 9.71622C20.2076 7.17051 18.5838 6.19622 17.159 6.19622H5.50953C4.06382 6.19622 2.5343 7.24384 1.98953 9.71622L1.09906 16.6305C0.449537 21.1562 3.06858 23 6.5781 23Z"
                                            stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path
                                            d="M6.42158 5.9448C6.42158 3.21389 8.63542 1.00004 11.3663 1.00004V1.00004C12.6814 0.994472 13.9445 1.51297 14.8763 2.4409C15.8082 3.36883 16.332 4.62973 16.332 5.9448V5.9448"
                                            stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M7.97149 11.0991H8.02387" stroke="currentColor" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M14.6453 11.0991H14.6977" stroke="currentColor" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
