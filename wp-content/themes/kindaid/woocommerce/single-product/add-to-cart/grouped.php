...
<form class="cart grouped_form"
	...
	<?php if ($quantites_required && $show_add_to_cart_button): ?>
		...
		<div class="tp-product-details-add-to-cart mb-15 mr-10 w-100">
			<button type="submit"
				class="tp-product-details-add-to-cart-btn single_add_to_cart_button alt<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>"><?php echo esc_html($product->single_add_to_cart_text()); ?></button>
		</div>
