...
if (comments_open()):
    ...
    <div id="comments" class="contact-form-box mb-50 tp-contact-form">
        ...
        $fields = array(
            'author' => '<div class="row"><div class="col-md-4 mb-20"><label class="tp-form-label" for="author" >' . esc_html__('Your name', 'kindaid') . '</label><input class="tp-input" type="text" name="author" id="author" placeholder="'.esc_attr__('Your Name','kindaid').'" value="'.esc_attr($commenter['comment_author']).'" '.($req ? 'required' : '').' ></div>',
            'email' => '<div class="col-md-4 mb-20">
            <label for="email" class="tp-form-label">' . esc_html__('Your Email', 'kindaid') . '</label>
            <input class="tp-input" type="email" id="email" placeholder="' . esc_attr__('Email', 'kindaid') . '" value="'.esc_attr($commenter['comment_author_email']).'" '.($req ? 'required' : '').' ></div>',
        ...
        $defaults = [
            'fields' => $fields,
            'comment_field' => '<div class="col-md-12 mb-20 ' . $cl . '"> <label for="comment" class="tp-form-label">' . esc_attr__('Your Comments *', 'kindaid') . '</label><textarea class="tp-input tp-textarea" id="comment" name="comment" placeholder="' . esc_attr__('Your Comment Here...', 'kindaid') . '"></textarea>
                </div>
            ',
