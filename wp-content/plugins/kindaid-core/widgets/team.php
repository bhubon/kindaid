...
class kindAid_Team extends \Elementor\Widget_Base {
    ...
    public function get_title(): string {
        return esc_html__('Team', 'kindaid');
    }
    ...
    public function get_keywords(): array {
        return ['team', 'home 01 hero', 'kindaid'];
    }
    ...
    protected function register_control_section() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Team Member Designation', 'kindaid-core'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Team Member Name', 'kindaid-core'),
            ]
        );
    ...
    protected function render(): void {
        ...
        if (!empty($settings['url'])) {
            $this->add_link_attributes('team_member_url', $settings['url']);
        }
        ?>
        ...
        <div class="tp-team-item text-center mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".3s">
            ...
            <div class="tp-team-content">
                <?php if (!empty($settings['designation'])): ?>
                    <span class="mb-10 d-block"><?php echo esc_html($settings['designation']); ?></span>
                <?php endif; ?>
                <?php if (!empty($settings['name'])): ?>
                    <h3 class="tp-team-title mb-10">
                        <a <?php echo $this->get_render_attribute_string('team_member_url'); ?>><?php echo esc_html($settings['name']); ?></a>
                    </h3>
                <?php endif; ?>

                <?php if (!empty($settings['content'])): ?>
                    <p><?php echo kd_kses($settings['content']); ?></p>
                <?php endif; ?>
                ...
                <div class="tp-team-social">
                    ...
                    <?php if (!empty($settings['linkedin_url'])): ?>
                        <a href="<?php echo esc_url($settings['linkedin_url']); ?>">
                            <svg width="24" height="24" viewBox="-2.4 -2.4 28.80 28.80" fill="none"
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    ...
                                    <rect x="3" y="9" width="4" height="13" stroke="currentColor" stroke-width="2"
