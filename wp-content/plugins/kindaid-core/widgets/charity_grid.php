...
class kindAid_Charity_Grid extends \Elementor\Widget_Base {
    ...
    public function get_name(): string {
        return 'kindaid_charity_grid';
    }

    public function get_title(): string {
        return esc_html__('Charity Grid', 'kindaid');
    }
    ...
    public function get_keywords(): array {
        return ['charity grid', 'home 01 hero', 'kindaid'];
    }
                                        ...
                                        <div class="tp-causes-button">
                                            <div class="tp-progress mb-10">
                                                ...
                                                <div class="progress" role="progressbar" aria-label="Example with label" aria-valuenow="70"
                                                    ...
                                                    <div class="progress-bar wow slideInLeft" data-wow-duration="1s" data-wow-delay=".1s"
                                    ...
                                    <div class="tp-causes-wrap mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".3s">
                                        ...
                                        <div class="tp-causes-content mb-35">
                                            ...
                                            <div class="tp-progress mb-10 mt-20">
                                                ...
                                                <div class="progress" role="progressbar" aria-label="Example with label" aria-valuenow="90"
                                                    aria-valuemin="0" aria-valuemax="100">
                                                    <div class="progress-bar wow slideInLeft" data-wow-duration="1s" data-wow-delay=".1s"
                                                        style="width: <?php echo esc_attr($percentage); ?>"></div>
                                                </div>
