...
class kindAid_Icon_Box extends \Elementor\Widget_Base {
    ...
    public function get_name(): string {
        return 'kindaid_icon_box';
    }

    public function get_title(): string {
        return esc_html__('Icon Box', 'kindaid');
    }
    ...
    public function get_keywords(): array {
        return ['icon box', 'home 01 hero', 'kindaid'];
    }
    ...
    protected function render(): void {
        ...
        <div class="tp-service-item icon-anime-wrap tp-bg-mulberry el-bg wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".3s">
            ...
            <?php if (!empty($settings['title'])): ?>
                <?php if (!empty($settings['box_url'])): ?>
                    <h3 class="tp-service-title mb-15 el-title"><a href="<?php echo esc_url($settings['box_url']); ?>"
                            class="common-underline"><?php echo kd_kses($settings['title']) ?></a></h3>
                <?php else: ?>
                    <h3 class="tp-service-title mb-15 el-title">
            ...
            <?php if (!empty($settings['description'])): ?>
                <p class="tp-service-dec mb-0 el-content"><?php echo kd_kses($settings['description']); ?></p>
            <?php endif; ?>
        </div>
        <?php
    }
