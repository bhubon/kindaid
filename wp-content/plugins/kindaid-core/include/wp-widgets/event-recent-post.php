...
class Kindaid_Event_Recent_Post extends \WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            __('Kindaid Upcoming Event', 'kindaid'),
            ...
            while ($query->have_posts()):
                ...
                <div class="tp-widget-post-list mb-15">
                    ...
                    <div class="tp-widget-post-content">
                        <span><i class="far fa-clock"></i> <?php echo esc_html(date('m d, Y', strtotime($start_date))); ?></span>
...
/* REGISTER WIDGET */
function register_kindaid_event_recent_post() {
    register_widget('Kindaid_Event_Recent_Post');
}
add_action('widgets_init', 'register_kindaid_event_recent_post');