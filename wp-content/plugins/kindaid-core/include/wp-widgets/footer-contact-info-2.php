<?php
class Kindaid_Footer_Contact_info_Wdget_2 extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'Kindaid_Footer_Contact_info_Wdget_2',
            __('Kindaid Footer Contact Info 2', 'kindaid'),
    ...
    public function widget($args, $instance) {
        ...
        $address = !empty($instance['address']) ? kindaid_kses($instance['address']) : '';
        ...
        <div class="tp-footer-3-cta">
            <?php if (!empty($address)): ?>
                <h3 class="tp-footer-cta-title mb-30"><a class="common-underline" href="<?php echo esc_url($address_url); ?>"
                        target="_blank"><?php echo kindaid_kses($address); ?></a></h3>
            <?php endif; ?>
            <?php if (!empty($phone)): ?>
    ...
    public function form($instance) {
        ...
        <p>
            ...
            <input class="widefat" type="text"
                name="<?php echo $this->get_field_name('title'); ?>" value="<?php echo esc_textarea($title); ?>">
        </p>
        ...
        <p><label>Mail:</label>
            <input class="widefat" type="text" name="<?php echo $this->get_field_name('mail'); ?>" value="<?php echo $mail; ?>">
        </p>
...
/* REGISTER WIDGET */
function register_kindaid_footer_contact_info_widget_2() {
    register_widget('Kindaid_Footer_Contact_info_Wdget_2');
}
add_action('widgets_init', 'register_kindaid_footer_contact_info_widget_2');